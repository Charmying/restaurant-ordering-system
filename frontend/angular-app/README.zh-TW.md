...
### 前端文件
- [**設定（repo `frontend/docs`）**](../docs/SETUP.zh-TW.md) — `cd angular-app`、npm、埠號
- [**依賴套件（repo `frontend/docs`）**](../docs/DEPENDENCIES.zh-TW.md) — npm 套件與使用方式
- [**i18n（Angular）**](./docs/I18N.zh-TW.md) — ngx-translate 實作
...
### 後端文件（repo `backend/docs`）
- [**Node API README**](../../backend/node-api/README.zh-TW.md) — NestJS 服務總覽
