...
- [**Setup (repo `frontend/docs`)**](../docs/SETUP.md) — `cd angular-app`, npm, ports
- [**Dependencies (repo `frontend/docs`)**](../docs/DEPENDENCIES.md) — npm packages and usage
- [**i18n (Angular)**](./docs/I18N.md) — ngx-translate implementation
...
### Backend documentation (repository `backend/docs`)
- [**Node API README**](../../backend/node-api/README.md) — NestJS service overview
