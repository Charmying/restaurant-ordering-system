...
Comprehensive system-level documentation for the restaurant ordering system. This directory contains cross-cutting documentation that applies to the entire system.
...
2. [Backend Setup](../backend/docs/SETUP.md) — Environment configuration
3. [Frontend Setup](../frontend/docs/SETUP.md) — Frontend build configuration
